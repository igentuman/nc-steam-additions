...
public class SteamTurbineCategory extends ParentProcessorCategory
{
	...
	{
		super(guiHelper, handler, SteamTurbine.code, 24, 7, 148, 56, proc);
		processor = proc;
	}
	...
	public static class SteamTurbineWrapper extends JEIMachineRecipeWrapper
	{
		...
		{
			if (recipe == null)
				return NCSteamAdditionsConfig.processor_time[SteamTurbine.GUID];
			return recipe.getBaseProcessTime(NCSteamAdditionsConfig.processor_time[SteamTurbine.GUID]);
		}
