...
@ZenRegister
public abstract class AbstractNCSteamAdditionsRecipeHandler<RECIPE extends INCSteamAdditionsRecipe>
{
	...
	public @Nullable
	NCSteamAdditionsRecipeInfo<RECIPE> getRecipeInfoFromInputs(List<ItemStack> itemInputs, List<Tank> fluidInputs)
	{
		...
		if (matchingRecipes != null)
		{
			...
			{
				NCSteamAdditionsRecipeMatchResult matchResult = recipe.matchInputs(itemInputs, fluidInputs,recipe.getExtras());
				if (matchResult.matches())
				{
					return new NCSteamAdditionsRecipeInfo(recipe, matchResult);
				}
			}
