...
public class GuiSteamBlender extends GuiItemFluidMachine
{
	...
	public GuiSteamBlender(EntityPlayer player, TileItemFluidProcessor tile, SteamBlender processor)
	{
		this(player, tile, new ContainerSteamBlender(player, tile), processor);
	}

	private GuiSteamBlender(EntityPlayer player, TileItemFluidProcessor tile, ContainerTile container, SteamBlender processor)
	{
