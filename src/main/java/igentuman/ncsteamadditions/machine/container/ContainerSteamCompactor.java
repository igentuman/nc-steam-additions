...
public class ContainerSteamCompactor extends ContainerItemFluidProcessor
{

	public ContainerSteamCompactor(EntityPlayer player, TileItemFluidProcessor tileEntity)
	{
