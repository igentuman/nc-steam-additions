...
public class AddNCSteamAdditionsRecipe implements IAction
{
	...
	public String describe() 
	{
		if (inputsAllNull || ingredientError || wasNull || wrongSize) {
			...
			return String.format("Error: Failed to add %s recipe: %s", recipeHandler.getRecipeName(), NCSteamAdditionsRecipeHelper.getRecipeString(itemIngredients, fluidIngredients, itemProducts, fluidProducts));
		}
